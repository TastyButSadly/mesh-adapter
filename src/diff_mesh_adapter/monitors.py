...
def advecting_gaussian_solution(points: Tensor, *, time: float, center0: tuple[float, float], velocity: tuple[float, float], sigma: float) -> Tensor:
...
def _moving_center(points: Tensor, *, time: float | Tensor, center0: tuple[float, float], velocity: tuple[float, float]) -> Tensor:
...
def _gaussian_gradient_norm(points: Tensor, *, time: float | Tensor, center0: tuple[float, float], velocity: tuple[float, float], sigma: float) -> Tensor:
    center = _moving_center(points, time=time, center0=center0, velocity=velocity)
